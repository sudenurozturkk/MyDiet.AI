  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-sky-50 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 font-inter">
      <div className="container mx-auto px-4 py-6">
        <div className="flex h-[calc(100vh-3rem)] bg-white/95 dark:bg-neutral-900/90 rounded-3xl shadow-2xl overflow-hidden border border-gray-200 dark:border-slate-700">
          
          {/* Ana Chat Bölümü */}
          <div className="flex-1 flex flex-col">
            
            {/* Başlık Alanı - Üstte */}
            <div className="flex items-center justify-between px-8 py-6 bg-gradient-to-r from-fitness-blue/5 to-fitness-green/5 dark:from-fitness-blue/10 dark:to-fitness-green/10 border-b border-gray-200 dark:border-slate-700">
              {/* Sol: Boş alan (dashboard ile çakışmaması için) */}
